...
add_action( 'save_post',         'smartr_get_the_Image_delete_cache_by_post'        );
add_action( 'deleted_post_meta', 'smartr_get_the_Image_delete_cache_by_meta', 10, 2 );
add_action( 'updated_post_meta', 'smartr_get_the_Image_delete_cache_by_meta', 10, 2 );
add_action( 'added_post_meta',   'smartr_get_the_Image_delete_cache_by_meta', 10, 2 );
 ...
 */
function smartr_get_the_Image( $args = array() ) {
 ...
 * what you're doing and expect your code to break in future versions.  Use the the `smartr_get_the_Image()` 
...
final class Smartr_Get_The_Image {
	...
	public function __construct( $args = array() ) {
		...
		add_filter( 'smartr_get_the_Image_post_content', array( $wp_embed, 'run_shortcode' ) );
		add_filter( 'smartr_get_the_Image_post_content', array( $wp_embed, 'autoembed'     ) );
	...
	public function get_image() {
		...
		$image_html = apply_filters( 'smartr_get_the_Image', $this->image );
	...
	public function find() {
		...
		$image_cache = wp_cache_get( $this->args['post_id'], 'smartr_get_the_Image' );
		...
		if ( !isset( $image_cache[ $key ] ) || empty( $cache ) ) {
			...
			if ( !empty( $this->image ) ) {
				...
				wp_cache_set( $this->args['post_id'], $image_cache, 'smartr_get_the_Image' );
			}
		}
	...
	public function get_scan_image() {
		...
		$post_content = apply_filters( 'smartr_get_the_Image_post_content', $post_content );
	...
	public function format_image() {
		...
		if ( $this->args['link_to_post'] )
			$html = '<a href="' . esc_url(get_permalink( $this->args['post_id'] )) . '" title="' . esc_attr( get_post_field( 'post_title', $this->args['post_id'] ) ) . '">' . $html . '</a>';
 ...
 * @return void
 */
function smartr_get_the_Image_delete_cache_by_post( $post_id ) {
	wp_cache_delete( $post_id, 'smartr_get_the_Image' );
}
 ...
 * @return void
 */
function smartr_get_the_Image_delete_cache_by_meta( $meta_id, $post_id ) {
	wp_cache_delete( $post_id, 'smartr_get_the_Image' );
}
 ...
 * @access     public
 */
function smartr_get_the_Image_link() {
	_deprecated_function( __FUNCTION__, '0.3.0', 'smartr_get_the_Image' );
	smartr_get_the_Image( array( 'link_to_post' => true ) );
}
 ...
 * @access     private
 */
function smartr_get_the_Image_delete_cache() {}
 ...
 * @access     private
 */
function smartr_get_the_Image_by_meta_key() {}
 ...
 * @access     private
 */
function smartr_get_the_Image_by_post_thumbnail() {}
 ...
 * @access     private
 */
function smartr_get_the_Image_by_attachment() {}
 ...
 * @access     private
 */
function smartr_get_the_Image_by_scan() {}
 ...
 * @access     private
 */
function smartr_get_the_Image_by_default() {}
 ...
 * @access     private
 */
function smartr_get_the_Image_format() {}
 ...
 * @access     private
 */
function smartr_get_the_Image_meta_key_save() {}
