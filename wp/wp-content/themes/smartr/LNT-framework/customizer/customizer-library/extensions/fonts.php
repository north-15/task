...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'smartr' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'smartr' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'smartr' ),
		'cyrillic'     => __( 'Cyrillic', 'smartr' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'smartr' ),
		'devanagari'   => __( 'Devanagari', 'smartr' ),
		'greek'        => __( 'Greek', 'smartr' ),
		'greek-ext'    => __( 'Greek Extended', 'smartr' ),
		'khmer'        => __( 'Khmer', 'smartr' ),
		'latin'        => __( 'Latin', 'smartr' ),
		'latin-ext'    => __( 'Latin Extended', 'smartr' ),
		'vietnamese'   => __( 'Vietnamese', 'smartr' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'smartr' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'smartr' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'smartr' ),
