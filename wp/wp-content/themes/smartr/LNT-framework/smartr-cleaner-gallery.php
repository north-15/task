 ...
 * @since  1.1.0
 */
final class Smatr_Cleaner_Gallery {
	...
	public function get_attachment_link( $link ) {
		...
		return preg_replace( '/(<a.*?)>/i', '$1 data-gal="prettyPhoto[gallery'.$post->ID.']" itemprop="contentURL">', $link );
	}
...
Smatr_Cleaner_Gallery::get_instance();
