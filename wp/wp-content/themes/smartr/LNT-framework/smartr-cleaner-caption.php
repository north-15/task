...
add_filter( 'img_caption_shortcode', 'smartr_cleaner_caption', 10, 3 );
 ...
 */
function smartr_cleaner_caption( $output, $attr, $content ) {
	...
	return apply_filters( 'smartr_cleaner_caption', $output );
}
